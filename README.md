...
Analizar la aplicación Flask básica. Explicar el funcionamiento de app = Flask(name), @app.route("/"), jsonify() y el modo debug=True, tomando como base Prueba_Flask_Routes_01.py.

Implementar una API REST de sensores.
...
Corregir y mejorar el manejo de IDs
...
Persistir lecturas de sensores en SQLite
...
Comparar este modelo con el desarrollado en el TP1.
